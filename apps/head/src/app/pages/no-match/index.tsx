...
const CenteredPanel = styled.div`
  ...
  #g6219 {
    ...
    animation: ${rotateAnimation} 12s 0.5s infinite ease-out;
  }
`;
...
const VectorEllipse = styled.ellipse`
  display: inline;
  opacity: 1;
  fill: none;
...
const DetailedPath = styled.path`
  display: inline;
  fill: #000000;
  stroke: none;
...
const DetailedStrokePath = styled.path`
  display: inline;
  fill: none;
  stroke: #000000;
  stroke-width: 1px;
...
const SimpleStrokePath = styled.path`
  display: inline;
  fill: none;
  stroke: #000000;
...
const SimpleEllipse = styled.ellipse`
  display: inline;
  opacity: 1;
  fill: #000000;
  fill-opacity: 1;
...
const DetailedEllipse = styled.ellipse`
  display: inline;
  opacity: 1;
  fill: #000000;
  fill-opacity: 1;
...
const EllipseWithLineStyle = styled.ellipse`
  ${test14}
`;

const PathWithLineStyle = styled.path`
  ${test14}
`;

const Test24 = styled.path`
  fill: none;
  stroke: #000000;
  stroke-width: 1px;
  stroke-linecap: butt;
...
const Test20 = styled.path``;

const Test21 = styled.path``;

const Test22 = styled.path``;

const Test23 = styled.path``;
        ...
        >
          ...
          <defs id="defs6">
            <pattern
              ...
              id="Strips2_1"
            >
              <VectorRect x="0" y="-0.5" width="1" height="2" id="rect5419" />
            </pattern>
            <linearGradient id="linearGradient6096">
              <GradientStop id="stop6094" offset="0" />
            </linearGradient>
          </defs>
